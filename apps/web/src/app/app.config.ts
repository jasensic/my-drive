...
import {
  ...
  ListSharesService,
  RevokeShareService,
} from './application/shares.use-cases';
import {
  ASSIGN_FILE_ALBUM,
  CHECK_SETUP,
  CONNECT_SPOTIFY,
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    { provide: REGISTER_ACCOUNT, useClass: RegisterAccountService },
    { provide: LIST_USERS, useClass: ListUsersService },
    ...
    { provide: LIST_SHARES, useClass: ListSharesService },
    { provide: CREATE_SHARE, useClass: CreateShareService },
    { provide: REVOKE_SHARE, useClass: RevokeShareService },
