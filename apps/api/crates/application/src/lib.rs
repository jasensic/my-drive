...
pub struct Services {
    ...
    pub rename_album: Arc<dyn RenameAlbum>,
    pub delete_album: Arc<dyn DeleteAlbum>,
    pub upload_file: Arc<dyn UploadFile>,
    pub list_files: Arc<dyn ListFiles>,
    pub get_file: Arc<dyn GetFile>,
    pub update_file: Arc<dyn UpdateFile>,
    pub get_file_content: Arc<dyn GetFileContent>,
    pub list_trash: Arc<dyn ListTrash>,
    pub trash_file: Arc<dyn TrashFile>,
    pub restore_file: Arc<dyn RestoreFile>,
    pub purge_file: Arc<dyn PurgeFile>,
    pub empty_trash: Arc<dyn EmptyTrash>,
...
impl Services {
    pub fn new(deps: Arc<Deps>) -> Self {
        Self {
            ...
            rename_album: Arc::new(RenameAlbumService::new(deps.clone())),
            delete_album: Arc::new(DeleteAlbumService::new(deps.clone())),
            ...
            update_file: Arc::new(UpdateFileService::new(deps.clone())),
            get_file_content: Arc::new(GetFileContentService::new(deps.clone())),
            list_trash: Arc::new(ListTrashService::new(deps.clone())),
            trash_file: Arc::new(TrashFileService::new(deps.clone())),
            restore_file: Arc::new(RestoreFileService::new(deps.clone())),
            purge_file: Arc::new(PurgeFileService::new(deps.clone())),
            empty_trash: Arc::new(EmptyTrashService::new(deps.clone())),
